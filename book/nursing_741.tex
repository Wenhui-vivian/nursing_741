...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Get the temp column}
\NormalTok{my_df}\OperatorTok{$}\NormalTok{temp}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# What's the mean of the temp column}
\KeywordTok{mean}\NormalTok{(my_df}\OperatorTok{$}\NormalTok{temp)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{nursing_741_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{filter}\NormalTok{(df, id }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mutate}\NormalTok{(df,}\DataTypeTok{old_young=}\KeywordTok{ifelse}\NormalTok{(df}\OperatorTok{$}\NormalTok{age}\OperatorTok{>=}\KeywordTok{mean}\NormalTok{(df}\OperatorTok{$}\NormalTok{age),}\StringTok{"Y"}\NormalTok{,}\StringTok{"N"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tmp <-}\StringTok{ }\KeywordTok{mutate}\NormalTok{(df, }\DataTypeTok{color =} \KeywordTok{ifelse}\NormalTok{(age }\OperatorTok{>}\StringTok{ }\KeywordTok{mean}\NormalTok{(age),}\StringTok{"red"}\NormalTok{,}\StringTok{"blue"}\NormalTok{)) }

\KeywordTok{plot}\NormalTok{(tmp}\OperatorTok{$}\NormalTok{age,}\DataTypeTok{col=}\NormalTok{tmp}\OperatorTok{$}\NormalTok{color, }\DataTypeTok{type=}\StringTok{"p"}\NormalTok{,}
     \DataTypeTok{pch=}\DecValTok{19}\NormalTok{,}\DataTypeTok{main=}\StringTok{"Ages"}\NormalTok{,}\DataTypeTok{ylab=}\StringTok{"Age"}\NormalTok{) }

\KeywordTok{grid}\NormalTok{()}

\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h=}\KeywordTok{mean}\NormalTok{(tmp}\OperatorTok{$}\NormalTok{age),}\DataTypeTok{lty=}\DecValTok{2}\NormalTok{)}

\KeywordTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{,}
       \KeywordTok{c}\NormalTok{(}\StringTok{"Above Avg"}\NormalTok{,}\StringTok{"Below Avg"}\NormalTok{),}\DataTypeTok{col=}\KeywordTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{,}\StringTok{"blue"}\NormalTok{),}\DataTypeTok{pch=}\DecValTok{19}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{nursing_741_files/figure-latex/unnamed-chunk-53-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df[}\KeywordTok{rev}\NormalTok{(}\KeywordTok{order}\NormalTok{(df}\OperatorTok{$}\NormalTok{age)),]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df[}\KeywordTok{order}\NormalTok{(df}\OperatorTok{$}\NormalTok{gender,}\OperatorTok{-}\NormalTok{df}\OperatorTok{$}\NormalTok{age),]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtcars }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(mpg, am) }\OperatorTok{%>%}\StringTok{ }\NormalTok{head}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtcars }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(mpg, am)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(gender) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{avg=}\KeywordTok{mean}\NormalTok{(age))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{avg=}\KeywordTok{mean}\NormalTok{(age),}\DataTypeTok{total=}\KeywordTok{n}\NormalTok{())}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{med_age=}\KeywordTok{median}\NormalTok{(age))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{results <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{              }\KeywordTok{filter}\NormalTok{(gender }\OperatorTok{==}\StringTok{ "MALE"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{              }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{med_age=}\KeywordTok{median}\NormalTok{(age))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtcars }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(wt }\OperatorTok{>}\StringTok{ }\FloatTok{3.3}\NormalTok{)  }\OperatorTok{%>%}
\StringTok{           }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ab_be=}\KeywordTok{ifelse}\NormalTok{(mpg }\OperatorTok{>}\StringTok{ }\KeywordTok{mean}\NormalTok{(mpg),}\StringTok{"Y"}\NormalTok{,}\StringTok{"N"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{           }\KeywordTok{group_by}\NormalTok{(ab_be) }\OperatorTok{%>%}\StringTok{ }
\StringTok{           }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_mpg=}\KeywordTok{mean}\NormalTok{(mpg))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mtcars }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(wt }\OperatorTok{>}\StringTok{ }\FloatTok{3.3}\NormalTok{)  }\OperatorTok{%>%}
\StringTok{           }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ab_be=}\KeywordTok{ifelse}\NormalTok{(mpg }\OperatorTok{>}\StringTok{ }\KeywordTok{mean}\NormalTok{(mpg),}\StringTok{"Y"}\NormalTok{,}\StringTok{"N"}\NormalTok{)  ) }\OperatorTok{%>%}
\StringTok{           }\KeywordTok{group_by}\NormalTok{(ab_be) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_mpg=}\KeywordTok{mean}\NormalTok{(mpg)) }\OperatorTok{%>%}
\StringTok{           }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{ab_be,}\DataTypeTok{y=}\NormalTok{mean_mpg)) }\OperatorTok{+}
\StringTok{           }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{) }\OperatorTok{+}
\StringTok{           }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Mean MPG"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"ab_be"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Mean MPG"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{nursing_741_files/figure-latex/unnamed-chunk-80-1.pdf}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(Sepal.Length }\OperatorTok{>}\StringTok{ }\FloatTok{4.7} \OperatorTok{&}\StringTok{ }\NormalTok{Sepal.Length }\OperatorTok{<}\StringTok{ }\FloatTok{5.0} \OperatorTok{&}\StringTok{ }\NormalTok{Species}\OperatorTok{==}\StringTok{"setosa"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\KeywordTok{c}\NormalTok{(Sepal.Length,Sepal.Width)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{(}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Or use a helper function to process strings}

\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\KeywordTok{starts_with}\NormalTok{(}\StringTok{"Sepal"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{(}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Or if you know which column numbers you want}

\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{(}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(Sepal.Width)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{(}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(Species) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{total=}\KeywordTok{n}\NormalTok{())}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{ends_with}\NormalTok{(}\StringTok{"Length"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{c}\NormalTok{(}\KeywordTok{ends_with}\NormalTok{(}\StringTok{"Length"}\NormalTok{),}\StringTok{"Species"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{ends_with}\NormalTok{(}\StringTok{"Length"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\StringTok{"Species"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Sepal.Width }\OperatorTok{>}\StringTok{ }\FloatTok{3.9}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{ends_with}\NormalTok{(}\StringTok{"Length"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\StringTok{"Species"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{ends_with}\NormalTok{(}\StringTok{"Length"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\StringTok{"Species"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(Sepal.Width }\OperatorTok{>}\StringTok{ }\FloatTok{3.9}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iris }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean=}\KeywordTok{mean}\NormalTok{(Sepal.Length),}
                   \DataTypeTok{sd=}\KeywordTok{sd}\NormalTok{(Sepal.Length),}
                   \DataTypeTok{max=}\KeywordTok{max}\NormalTok{(Sepal.Length),}
                   \DataTypeTok{min=}\KeywordTok{min}\NormalTok{(Sepal.Length))}
\end{Highlighting}
\end{Shaded}
